        ...
        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div className="property-item rounded overflow-hidden">
                <div className="position-relative overflow-hidden">
                    <Link to="/details"><img className="img-fluid" src={estate.image.first} alt="" style={{width:"100%",height:"270px"}} /></Link>
                ...
                <div className="d-flex border-top">
                    <small className="flex-fill text-center border-end py-2"><i className="fa fa-ruler-combined text-primary me-2"></i>{estate.meters}</small>
                    <small className="flex-fill text-center border-end py-2"><i className="fa fa-bed text-primary me-2"></i>{estate.rooms} Rooms</small>
                    <small className="flex-fill text-center py-2"><i className="fa fa-bath text-primary me-2"></i>{estate.bath} Bath</small>
                </div>
            </div>
        </div>
    )
